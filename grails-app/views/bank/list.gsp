                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <g:sortableColumn property="website" title="${message(code: 'bank.website.label', default: 'Website')}" />
                        
                            <th><g:message code="bank.bankOwner.label" default="Bank Owner" /></th>
                    ...
                    <g:each in="${bankInstanceList}" status="i" var="bankInstance">
                        <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                            ...
                            <td>${fieldValue(bean: bankInstance, field: "website")}</td>
                        
                            <td>${fieldValue(bean: bankInstance, field: "bankOwner")}</td>
