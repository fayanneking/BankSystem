            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="user.contactNo.label" default="Contact No" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: userInstance, field: "contactNo")}</td>
                            
                        </tr>
                    
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="user.bankAccounts.label" default="Bank Accounts" /></td>
