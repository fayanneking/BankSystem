                    ...
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: userInstance, field: 'contactNo', 'errors')}">
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="bankAccounts"><g:message code="user.bankAccounts.label" default="Bank Accounts" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: userInstance, field: 'bankAccounts', 'errors')}">
...
<g:link controller="bankAccount" action="create" params="['user.id': userInstance?.id]">${message(code: 'default.add.label', args: [message(code: 'bankAccount.label', default: 'BankAccount')])}</g:link>
